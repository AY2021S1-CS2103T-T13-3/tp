...
import seedu.address.logic.parser.schedule.EditPaymentCommandParser;
...
public class AddressBookParser {
    ...
    static {
        ...
        commandMapper.put(EditPaymentCommand.COMMAND_WORD, (args) -> new EditPaymentCommandParser().parse(args));
